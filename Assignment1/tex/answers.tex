...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/kmean_l.tikz}}
...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/kmean_o.tikz}}
...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/kmean_x.tikz}}
...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/nubs_l.tikz}}
...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/nubs_o.tikz}}
...
\begin{figure}[h!]
  	\centering
    \scalebox{.5}{\input{img/nubs_x.tikz}}
